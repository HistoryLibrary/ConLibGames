                  ...
                  -=* ================================= *=-
                  -=* The ConLib Console Library (v1.0) *=-
                  -=* ================================= *=-
...
2) The linker will need access to the ConLib library so your function calls
   ...
   b) In the "Object/library modules" edit control, place your cursor at the
      end of the file list and add "ConLib.lib".
   ...
   c) The linker will need to locate the ConLib library file when you build
      ...
      ConLib.lib file in the same subdirectory where your source code files
      are located.  An alternate method is to place the library in the
      subdirectory of your own choosing, then updating the library path the
      linker searches (you can find this by traversing the menu path "Tools ->
      Options" and selecting "Library files" from the drop-down list control
      for directories).
