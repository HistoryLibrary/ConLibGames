...
BOOL    ConLibReadInputRecord(INPUT_RECORD  *recPtr);
...
//      possible values are:
//
//          LEFT_MOUSE_BUTTON_PRESSED   -- the left mouse button was pressed
//
//          RIGHT_MOUSE_BUTTON_PRESSED  -- the right mouse button was pressed
//
//          NO_MOUSE_BUTTON_PRESSED     -- neither the left or right mouse
//                                         button was pressed
//
// ============================================================================
...
// which removes the record from the input buffer.
//
// Input:
